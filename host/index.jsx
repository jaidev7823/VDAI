 function jaiCutActiveSequence(silences, backup) {
    ...
    // Make a backup of the sequence before initiating jaicuts.
    if (MAKE_BACKUP) {
        SEQUENCE.clone();
    }

    // Perform jai cuts with razor tool
...
// Get the file path of the clip that should be jai cut.
